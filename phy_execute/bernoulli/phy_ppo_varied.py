...
def run(workspace: str,
    ...
    environment: PhyEnvironment = PhyEnvironment("phy_environment", urllc_param=None, rl_env_ver='bernoulli',
                                                 cw_tot_number=120, cw_class=None, q_norm=0, random_queue=True)
